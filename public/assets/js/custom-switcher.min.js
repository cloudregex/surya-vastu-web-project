...
function switcherClick() {
    ...
    let backgroundColor2Var = bgDefaultColor2Btn.addEventListener(
        ...
        () => {
            ...
            document
                .querySelector("html")
                .style.setProperty("--light-rgb", "16, 104, 104");
            document
                .querySelector("html")
                .style.setProperty("--form-control-bg", "rgb(16, 104, 104)");
            document
                .querySelector("html")
                .style.setProperty("--input-border", "rgba(255,255,255,0.1)");
            document.querySelector("#switcher-dark-theme").checked = true;
    ...
    let backgroundColor3Var = bgDefaultColor3Btn.addEventListener(
        ...
        () => {
            ...
            document
                .querySelector("html")
                .style.setProperty("--light-rgb", "98, 51, 140");
            document
                .querySelector("html")
                .style.setProperty("--form-control-bg", "rgb(98, 51, 140)");
            document
                .querySelector("html")
                .style.setProperty("--input-border", "rgba(255,255,255,0.1)");
            document.querySelector("#switcher-dark-theme").checked = true;
    ...
    let backgroundColor4Var = bgDefaultColor4Btn.addEventListener(
        ...
        () => {
            ...
            document
                .querySelector("html")
                .style.setProperty("--light-rgb", "28, 103, 53");
            document
                .querySelector("html")
                .style.setProperty("--form-control-bg", "rgb(28, 103, 53)");
            document
                .querySelector("html")
                .style.setProperty("--input-border", "rgba(255,255,255,0.1)");
            document.querySelector("#switcher-dark-theme").checked = true;
    ...
    let backgroundColor5Var = bgDefaultColor5Btn.addEventListener(
        ...
        () => {
            ...
            document
                .querySelector("html")
                .style.setProperty("--light-rgb", "172, 56, 56");
            document
                .querySelector("html")
                .style.setProperty("--form-control-bg", "rgb(172, 56, 56)");
            document
                .querySelector("html")
                .style.setProperty("--input-border", "rgba(255,255,255,0.1)");
            document.querySelector("#switcher-dark-theme").checked = true;
    ...
    /* loader end */
    if (
        localStorage.getItem("loaderEnable") == null ||
        localStorage.getItem("loaderEnable") == "false" ||
        localStorage.getItem("loaderEnable") == false
    ) {
        localStorage.setItem("loaderEnable", "true");
    }
