...
function previewImage(event, name) {
    ...
    let previewCol = $("#preview-col-" + name);
    let previewImg = $("#preview-img-" + name);
    let previewLink = $("#preview-link-" + name);
    let uploadCol = $("#preview-cols-" + name);
    ...
    if (fileInput.files && fileInput.files[0]) {
        ...
        reader.onload = function (e) {
            ...
            previewCol.removeClass("d-none"); // Show preview
            uploadCol.removeClass("col-md-12").addClass("col-md-8");
        };
