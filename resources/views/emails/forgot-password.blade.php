...
<body style="margin:0;background-color:#091548;padding:0;-webkit-text-size-adjust:none;text-size-adjust:none">
    <table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation"
        style="mso-table-lspace:0;mso-table-rspace:0;background-color:#091548">
        <tbody>
            <tr>
                <td>
                    <table class="row row-1" align="center" width="100%" border="0" cellpadding="0"
                        cellspacing="0" role="presentation"
                        style="mso-table-lspace:0;mso-table-rspace:0;background-color:#091548;background-image:url(https://d1oco4z2z1fhwp.cloudfront.net/templates/default/3986/background_2.png);background-position:center top;background-repeat:repeat">
                        <tbody>
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        cellspacing="0" role="presentation"
                                        style="mso-table-lspace:0;mso-table-rspace:0;color:#000;width:600px;margin:0 auto"
                                        width="600">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                    style="mso-table-lspace:0;mso-table-rspace:0;font-weight:400;text-align:left;padding-bottom:15px;padding-left:10px;padding-right:10px;padding-top:5px;vertical-align:top;border-top:0;border-right:0;border-bottom:0;border-left:0">
                                                    <div class="spacer_block block-1"
                                                        style="height:8px;line-height:8px;font-size:1px">&#8202;</div>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><img
                                                                        ...
                                                                        style="display:block;height:auto;border:0;max-width:232px;width:100%"
                                                    ...
                                                    <table class="paragraph_block block-3" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    style="color:#fff;font-family:'Varela Round','Trebuchet MS',Helvetica,sans-serif;font-size:30px;line-height:120%;text-align:center;mso-line-height-alt:36px">
                                                    ...
                                                    <table class="paragraph_block block-4" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#fff;font-family:'Varela Round','Trebuchet MS',Helvetica,sans-serif;font-size:14px;line-height:150%;text-align:center;mso-line-height-alt:21px">
                                                                    <p style="margin:0;word-break:break-word">Dear
                                                                        {{ $name }}, We have
                                                                        received a request to reset your <br> password.
                                                                        Don’t
                                                                        worry,</p>
                                                                    <p style="margin:0;word-break:break-word">we are
                                                                        here to help you.</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table class="paragraph_block block-7" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    style="color:#7f96ef;font-family:'Varela Round','Trebuchet MS',Helvetica,sans-serif;font-size:14px;line-height:150%;text-align:center;mso-line-height-alt:21px">
                                                                    <p style="margin:0;word-break:break-word">
                                                                        <strong>Didn’t request a password
                                                                            reset?</strong>
                                                                    </p>
                                                                    <p style="margin:0;word-break:break-word">You can
                                ...
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                    style="mso-table-lspace:0;mso-table-rspace:0;font-weight:400;text-align:left;padding-bottom:15px;padding-left:10px;padding-right:10px;padding-top:15px;vertical-align:top;border-top:0;border-right:0;border-bottom:0;border-left:0">
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div class="alignment" align="center"
                                                                    ...
                                                                    <img src="{{ asset($profilePhotoUrl != null ? 'storage/' . $profilePhotoUrl : 'assets/images/brand-logos/desktop-white.png') }}"
                                                    ...
                                                    <table class="paragraph_block block-4" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#4a60bb;font-family:'Varela Round','Trebuchet MS',Helvetica,sans-serif;font-size:12px;line-height:120%;text-align:center;mso-line-height-alt:14.399999999999999px">
                                                                    <p style="margin:0;word-break:break-word">
                                                                        <span>Copyright © {{ date('Y') }}
                                                                            {{ env('MAIL_BUSINESS_NAME') }},
                                                                            All rights reserved.
                                                                        </span>
                                                                    </p>
