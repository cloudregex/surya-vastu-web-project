<x-card-comp listRoute="admin.gallery.list" listButtonName="Go to Team List" title="Create Team">
    <x-slot name="CardBody">
        <div class="row">
            ...
            <x-input type="number" placeholder="Enter Testimonial Sequence" col="6"
                name="columns.gallery_sequence" value="" label="Testimonial Sequence" />
        </div>
    </x-slot>
</x-card-comp>
