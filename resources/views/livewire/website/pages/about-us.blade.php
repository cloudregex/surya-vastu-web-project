        ...
        <div class="row  gy-4">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="text-center">
                    ...
                    <h1 class="display-4 text-white mb-0" data-toggle="counter-up">100+</h1>
                    <span class="fs-5 text-white">Skilled Professionals</span>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="text-center">
                    <i class="fa fa-calendar fa-3x text-white mb-3"></i>
                    <h1 class="display-4 text-white mb-0" data-toggle="counter-up">13+</h1>
                    <span class="fs-5 text-white">Years of Experience</span>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="text-center">
                    <i class="fa fa-smile fa-3x text-white mb-3"></i>
                    <h1 class="display-4 text-white mb-0" data-toggle="counter-up">200+</h1>
